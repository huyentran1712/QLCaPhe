    ...
    public partial class QLBHKH : Form
    {
        ...
        void LoadKhuVuc()
        {
            ...
            while (dr.Read())
            {
                ...
                button.Name = dr["KHUVUC"].ToString();
        ...
        void Ban_Click(object sender, EventArgs e)
        {
            ...
            MaBan = ban.Name;
            string sql = "SELECT TOP 1 MAHD FROM HOADON WHERE MABAN= '" + MaBan + "' ORDER BY NGAYVAO DESC";
            conn = new SqlConnection(DB.ConnectString);
            conn.Open();
            ...
            string sql2 = "SELECT MAKH FROM HOADON WHERE MAHD = '"+_MaHD+"'";
