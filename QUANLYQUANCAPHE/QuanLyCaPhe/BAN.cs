...
namespace QuanLyCaPhe
{
    public partial class BAN : Form
    {
        ...
        void load_data()
        {
            string sqlSelect = "select MABAN, TENBAN, KHUVUC, TENKHUVUC= (SELECT TENKHUVUC FROM KHUVUC WHERE KHUVUC.KHUVUC = BAN.KHUVUC), '' from BAN";
        ...
        {
            string sqlUpdate = "update BAN set TENBAN = @TenBan, KHUVUC = @MaKhuVuc where MABAN = @MaBan";
        ...
        {
            string strFind = "select MABAN, TENBAN, KHUVUC, TENKHUVUC= (SELECT TENKHUVUC FROM KHUVUC WHERE KHUVUC.KHUVUC = BAN.KHUVUC), '' from BAN where MABAN LIKE @TuKhoa OR TENBAN LIKE @TuKhoa OR KHUVUC LIKE @TuKhoa";
