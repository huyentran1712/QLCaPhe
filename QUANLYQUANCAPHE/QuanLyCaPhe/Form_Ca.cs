    ...
    public partial class Form_Ca : Form
    {
        ...
        private void bt_sua_Click(object sender, EventArgs e)
        {
            if (CheckData())
            {
                ...
                {
                    MessageBox.Show("Bị Lỗi Không Sửa Được");
                }
            }
        }
        ...
        private void bt_xoa_Click(object sender, EventArgs e)
        {
            if (CheckData())
            {
                ...
                {
                    MessageBox.Show("Bị Lỗi Không Xóa Được");
                }
            }
        }
        ...
        private void dataGridView1_RowPrePaint(object sender, DataGridViewRowPrePaintEventArgs e)
        {
            ...
            if (index >= 0)
            {
                tb_manhanvien.Text = dataGridView1.Rows[index].Cells["MANV"].Value.ToString();
                tb_maca.Text = dataGridView1.Rows[index].Cells["MACA"].Value.ToString();
                tb_makhuvuc.Text = dataGridView1.Rows[index].Cells["KHUVUC"].Value.ToString();
